          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              window.setTimeout(function () {
                location.assign('/'); //go back to homepage
              }, 700);
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2llbnZvMTIwMiIsImEiOiJjanpyeXlqZGgwMGlyM2h0NHRlaTVrODMxIn0.5YohfpmNhOcMzrtrm4x6RQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // put to container with id map
    style: 'mapbox://styles/kienvo1202/cjzrzbgoi4vif1dpfeut3iv68',
    scrollZoom: false // center: [-118.310182, 34.038906],
    // zoom: 10,
    // interactive: false
...
var stripe = Stripe('pk_test_1TlaMyinc27emdUolEFzFOQ200ysFZAAwG');
